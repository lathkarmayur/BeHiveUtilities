...
class CCPCountry : Comparable<CCPCountry> {
    ...
    var flagResID = DEFAULT_FLAG_RES
     ...
     * @return
     */
    fun isEligibleForQuery(query_: String): Boolean {
        var query = query_
    ...
    companion object {
        ...
        fun getCountryForCodeFromEnglishList(code: String): CCPCountry? {
            val countries: List<CCPCountry> = libraryMasterCountriesEnglish
        ...
        fun getFlagMasterResID(CCPCountry: CCPCountry): Int {
            return when (CCPCountry.nameCode?.toLowerCase(Locale.getDefault())) {
         ...
         * @return
         */
        val libraryMasterCountriesEnglish: List<CCPCountry>
            get() {
